...
<html>
    ...
    <body>
        <div class=" container">
            ...
            <center><h1 class="mau">Table Photo list</h1></center>
            
            <br>
            <a href="addphoto.jsp" class="icon-link">
            ...
            <table id="striped-table"  >
                ...
                <c:forEach items="${requestScope.photo}" var="c" varStatus="loop"  >
